...
startButton.addEventListener('click', function() {
    const initialTradePercentage = parseInt(document.getElementById('initialTradePercentage').value);
    
    if (isNaN(initialTradePercentage) || initialTradePercentage < 1 || initialTradePercentage > 100) {
        displayMessage('Error: Initial Trade Percentage must be between 1 and 100', 'red');
        return;
    }
    ...
    const params = {
        ...
        initialTradePercentage: initialTradePercentage
    };
